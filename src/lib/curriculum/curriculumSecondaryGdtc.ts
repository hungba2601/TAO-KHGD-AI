...
export function getGdtcSecondaryCurriculum(grade: string): RawSecondaryLesson[] {
  ...
  if (g === 6) {
    const grade6Weeks = [
      ...
      },
      {
        ...
        nls: '5.2.TC1a',
        ai: '6.C2.2',
        dc: '• [Mã NLS: 5.2.TC1a] Sử dụng thiết bị số (đồng hồ bấm giây điện tử, camera smartphone) ghi lại nhịp bước chạy giữa quãng.\n• [Mã AI: 6.C2.2] Xem mô phỏng AI phân tích góc đánh tay và góc ngả thân người chuẩn xác.'
      },
      {
        w: 3,
        t: 'Chủ đề 1. Chạy cự li ngắn (60 m)',
        ...
        nls: '2.1.TC1a',
        ai: '6.A1.1',
        dc: '• [Mã NLS: 2.1.TC1a] Tương tác qua video mẫu chuẩn kỹ thuật xuất phát cao trên hệ thống học liệu số LMS.\n• [Mã AI: 6.A1.1] Nhận biết cảm biến âm thanh AI hỗ trợ báo hiệu xuất phát tự động trong thi đấu.'
      },
      {
        w: 4,
        t: 'Chủ đề 1. Chạy cự li ngắn (60 m)',
      ...
      },
      {
        ...
        nls: '3.1.TC1a',
        ai: '6.C1.1',
        dc: '• [Mã NLS: 3.1.TC1a] Quay video thực hành bài tập thể dục nhóm và lưu trữ lên thư mục số Google Drive/LMS.\n• [Mã AI: 6.C1.1] Sử dụng AI nhận diện tư thế (Pose Estimation AI) kiểm tra độ chính xác của góc giơ tay.'
      },
      {
        w: 6,
        t: 'Chủ đề 4. Bài tập thể dục',
      ...
      },
      {
        ...
        nls: '1.3.TC1a',
        ai: '6.D1.1',
        dc: '• [Mã NLS: 1.3.TC1a] Nhập số liệu thành tích chạy 60m và điểm kiểm tra thử vào bảng tính số theo dõi tiến độ.\n• [Mã AI: 6.D1.1] Sử dụng biểu đồ số dự báo mức độ sẵn sàng thể lực trước kỳ kiểm tra định kỳ.'
      },
      {
        w: 9,
        t: 'Đánh giá định kỳ',
      ...
      },
      {
        ...
        nls: '4.1.TC1a',
        ai: '6.C1.1',
        dc: '• [Mã NLS: 4.1.TC1a] Xem infographic hướng dẫn an toàn khu vực ném bóng và quy tắc nhặt bóng trên sân tập.\n• [Mã AI: 6.C1.1] Mô phỏng 3D quỹ đạo bay tối ưu của quả bóng ném theo góc ném 38-42 độ.'
      },
      {
        w: 11,
        t: 'Chủ đề 2. Ném bóng',
        ...
        nls: '5.2.TC1a',
        ai: '6.C2.2',
        dc: '• [Mã NLS: 5.2.TC1a] Sử dụng thước đo laser kỹ thuật số hoặc ứng dụng đo khoảng cách thành tích ném bóng.\n• [Mã AI: 6.C2.2] Ứng dụng AI phân tích góc độ ra sức cuối cùng từ ảnh chụp chuyển động (Burst mode AI).'
      },
      {
        w: 12,
        t: 'Chủ đề 2. Ném bóng',
        ...
        nls: '2.4.TC1a',
        ai: '6.D1.1',
        dc: '• [Mã NLS: 2.4.TC1a] Làm việc nhóm phân công quay video và đo đạc cự li ném bóng của các thành viên.\n• [Mã AI: 6.D1.1] Trợ lý AI gợi ý điều chỉnh số bước đà dựa trên chiều cao và sải tay học sinh.'
      },
      {
        w: 13,
      ...
      },
      {
        ...
        nls: '5.2.TC1a',
        ai: '6.D1.1',
        dc: '• [Mã NLS: 5.2.TC1a] Ghi nhận đồ thị biến thiên tốc độ của từng học sinh qua ứng dụng thể thao số.\n• [Mã AI: 6.D1.1] AI gợi ý chiến thuật phân phối sức (Pacing strategy) phù hợp với thể trạng cá nhân.'
      },
      {
        w: 16,
        t: 'Đánh giá định kỳ',
      ...
      },
      {
        ...
        nls: '5.2.TC1a',
        ai: '6.C2.2',
        dc: '• [Mã NLS: 5.2.TC1a] Ghi lại chỉ số tốc độ bước chạy bằng ứng dụng cảm biến chuyển động điện thoại.\n• [Mã AI: 6.C2.2] AI phân tích biểu đồ tăng tốc để đề xuất bài tập bổ trợ cơ đùi phù hợp.'
      },
      {
        w: 21,
        t: 'Chủ đề 2. Ném bóng',
        ...
        nls: '3.1.TC1a',
        ai: '6.D1.1',
        dc: '• [Mã NLS: 3.1.TC1a] Lưu trữ và chia sẻ video kỹ thuật ném bóng của nhóm lên nhóm học tập số.\n• [Mã AI: 6.D1.1] AI hỗ trợ nhận diện lỗi sai thường gặp khi bước chéo chạy đà ném bóng.'
      },
      {
        w: 22,
        t: 'Chủ đề 4. Bài tập thể dục',
      ...
      },
      {
        ...
        nls: '2.1.TC1a',
        ai: '6.C2.2',
        dc: '• [Mã NLS: 2.1.TC1a] Xem hình ảnh 3D mô phỏng điểm tiếp xúc giữa bàn chân/mặt vợt với bóng/cầu.\n• [Mã AI: 6.C2.2] Ứng dụng AI phân tích góc tiếp xúc mặt vợt để tối ưu đường bay của quả cầu.'
      },
      {
        w: 24,
        t: 'Phần ba: Thể thao tự chọn',
        ...
        nls: '5.2.TC1a',
        ai: '6.C1.1',
        dc: '• [Mã NLS: 5.2.TC1a] Sử dụng bảng chiến thuật số trên máy tính bảng để mô phỏng bài tập chuyền bóng.\n• [Mã AI: 6.C1.1] Trợ lý AI gợi ý các bài tập cảm giác bóng/cầu thích ứng theo trình độ từng bạn.'
      },
      {
        w: 25,
        t: 'Phần ba: Thể thao tự chọn',
        ...
        nls: '2.4.TC1a',
        ai: '6.D1.1',
        dc: '• [Mã NLS: 2.4.TC1a] Sử dụng ứng dụng quản lý giải đấu số (Tournament Manager App) xếp lịch đấu lớp.\n• [Mã AI: 6.D1.1] AI hỗ trợ thống kê số lần đánh cầu qua lưới/chuyền bóng thành công trong trận đấu.'
      },
      {
        w: 26,
        t: 'Đánh giá định kỳ',
      ...
      },
      {
        ...
        nls: '1.3.TC1a',
        ai: '6.C1.1',
        dc: '• [Mã NLS: 1.3.TC1a] Nhập kết quả kiểm tra thể lực vào hệ thống cơ sở dữ liệu quốc gia về thể lực học sinh.\n• [Mã AI: 6.C1.1] AI tự động đối chiếu phân loại thể lực Tốt/Đạt/Chưa đạt theo Quyết định 53/2008/QĐ-BGDĐT.'
      },
      {
        w: 32,
        ...
        nls: '3.1.TC1a',
        ai: '6.C2.2',
        dc: '• [Mã NLS: 3.1.TC1a] Thiết kế poster kỹ thuật số cổ động ngày hội thể thao bằng công cụ Canva.\n• [Mã AI: 6.C2.2] Ứng dụng AI tạo video highlight các khoảnh khắc thể thao đẹp mắt của khối lớp.'
      },
      {
        w: 33,
      ...
      },
      {
        ...
        nls: '1.3.TC1a',
        ai: '6.A1.3',
        dc: '• [Mã NLS: 1.3.TC1a] Lưu trữ và đồng bộ hồ sơ đánh giá thể chất điện tử của học sinh lớp 6 lên phần mềm VNEDU/SMAS.\n• [Mã AI: 6.A1.3] AI tổng kết thống kê tỉ lệ đạt chuẩn thể lực toàn khối gửi ban giám hiệu nhà trường.'
      }
    ];
  ...
  if (g === 7) {
    const grade7Weeks = [
      ...
      },
      {
        ...
        nls: '5.2.TC1a',
        ai: '7.C5.1',
        dc: '• [Mã NLS: 5.2.TC1a] Sử dụng máy tính bảng quay video góc nghiêng chuyển tiếp giữa chạy lao và chạy giữa quãng.\n• [Mã AI: 7.C5.1] AI phân tích độ mượt mà của quỹ đạo trọng tâm cơ thể trong giai đoạn chuyển tiếp.'
      },
      {
        w: 3,
        t: 'Chủ đề 1. Chạy cự li ngắn (60 m)',
      ...
      },
      {
        ...
        nls: '1.3.TC1a',
        ai: '7.A1.1',
        dc: '• [Mã NLS: 1.3.TC1a] Nhập kết quả tự kiểm tra thử vào bảng biểu số theo dõi tiến trình cá nhân.\n• [Mã AI: 7.A1.1] AI gợi ý trọng tâm cần ôn luyện thêm trước kỳ thi giữa học kỳ.'
      },
      {
        w: 8,
      ...
      },
      {
        ...
        nls: '4.1.TC1a',
        ai: '7.C5.1',
        dc: '• [Mã NLS: 4.1.TC1a] Xem infographic quy tắc an toàn khi tập luyện tại hố nhảy xa (xới cát mềm, tránh chấn thương).\n• [Mã AI: 7.C5.1] Mô phỏng 3D góc giậm nhảy tối ưu 18-24 độ trong kỹ thuật nhảy xa kiểu ngồi.'
      },
      {
        w: 11,
        t: 'Chủ đề 2. Nhảy xa kiểu ngồi',
        ...
        nls: '5.2.TC1a',
        ai: '7.D1.1',
        dc: '• [Mã NLS: 5.2.TC1a] Sử dụng thiết bị quay chậm (Slow-motion) phân tích khoảnh khắc đặt chân lên ván giậm.\n• [Mã AI: 7.D1.1] Trợ lý AI hỗ trợ tính toán vị trí vạch đo đà chuẩn xác dựa trên chiều dài sải chân.'
      },
      {
        w: 12,
        t: 'Chủ đề 2. Nhảy xa kiểu ngồi',
      ...
      },
      {
        ...
        nls: '2.4.TC1a',
        ai: '7.D1.1',
        dc: '• [Mã NLS: 2.4.TC1a] Hợp tác nhóm tổ chức đo đạc và quay video phân tích thành tích nhảy xa của từng bạn.\n• [Mã AI: 7.D1.1] AI lập đồ thị so sánh thành tích qua từng lần nhảy để điều chỉnh lực giậm nhảy.'
      },
      {
        w: 14,
        t: 'Chủ đề 3. Chạy cự li trung bình',
        ...
        nls: '1.1.TC1a',
        ai: '7.A1.1',
        dc: '• [Mã NLS: 1.1.TC1a] Tìm kiếm tài liệu khoa học về nguyên lí trao đổi khí và nhịp tim tối đa khi chạy bền.\n• [Mã AI: 7.A1.1] Ứng dụng AI phân tích dữ liệu đồng hồ thông minh theo dõi chỉ số VO2 Max ước tính.'
      },
      {
        w: 15,
        t: 'Chủ đề 3. Chạy cự li trung bình',
        ...
        nls: '5.2.TC1a',
        ai: '7.C5.1',
        dc: '• [Mã NLS: 5.2.TC1a] Thu thập dữ liệu thời gian từng vòng chạy (Split time) bằng phần mềm bấm giờ số.\n• [Mã AI: 7.C5.1] AI mô phỏng biểu đồ phân bổ năng lượng tối ưu cho cự li trung bình 600m.'
      },
      {
        w: 16,
        t: 'Đánh giá định kỳ',
      ...
      },
      {
        ...
        nls: '2.1.TC1a',
        ai: '7.C5.1',
        dc: '• [Mã NLS: 2.1.TC1a] Xem video 3D slow-motion phân tích trục xoay của hông khi phát cầu/đá bóng mu trong.\n• [Mã AI: 7.C5.1] AI phân tích độ xoáy và góc bay của đường bóng đá mu trong bàn chân.'
      },
      {
        w: 23,
        t: 'Phần ba: Thể thao tự chọn',
        ...
        nls: '5.2.TC1a',
        ai: '7.D1.1',
        dc: '• [Mã NLS: 5.2.TC1a] Sử dụng cảm biến số đo vận tốc bay của quả cầu lông khi đánh cao tay.\n• [Mã AI: 7.D1.1] Trợ lý AI gợi ý bài tập cải thiện cảm giác bóng cho từng học sinh.'
      },
      {
        w: 24,
        t: 'Phần ba: Thể thao tự chọn',
        ...
        nls: '2.4.TC1a',
        ai: '7.C5.1',
        dc: '• [Mã NLS: 2.4.TC1a] Hợp tác nhóm xây dựng kịch bản phối hợp tấn công 2 đánh 1 trên bảng sơ đồ số.\n• [Mã AI: 7.C5.1] AI phân tích nhịp bước chân thứ nhất (dài) và bước chân thứ hai (ngắn) khi lên rổ.'
      },
      {
        w: 25,
        t: 'Phần ba: Thể thao tự chọn',
        ...
        nls: '3.1.TC1a',
        ai: '7.D1.1',
        dc: '• [Mã NLS: 3.1.TC1a] Sử dụng bảng tỷ số điện tử trên tablet để điều hành trận đấu trực quan.\n• [Mã AI: 7.D1.1] AI thống kê tỷ lệ ném rổ thành công và tỷ lệ kiểm soát bóng của hai đội.'
      },
      {
        w: 26,
        t: 'Đánh giá định kỳ',
        ...
        nls: '1.2.TC1a',
        ai: '7.B3.1',
        dc: '• [Mã NLS: 1.2.TC1a] Tra cứu barem điểm kiểm tra kỹ thuật thể thao tự chọn lớp 7 theo phân phối chương trình.\n• [Mã AI: 7.B3.1] Ghi nhận minh chứng hình ảnh/video kiểm tra đảm bảo tính công bằng, minh bạch.'
      },
      {
        w: 27,
        t: 'Chủ đề 3. Chạy cự li trung bình',
      ...
      },
      {
        ...
        nls: '2.1.TC1a',
        ai: '7.D1.1',
        dc: '• [Mã NLS: 2.1.TC1a] Xem hướng dẫn sơ đồ thi đấu trò chơi vận động qua máy chiếu/tablet ngoài trời.\n• [Mã AI: 7.D1.1] AI gợi ý cách phân nhóm thi đua cân bằng thể lực tạo không khí hào hứng.'
      },
      {
        w: 29,
        t: 'Phần ba: Thể thao tự chọn',
        ...
        nls: '2.4.TC1a',
        ai: '7.C5.1',
        dc: '• [Mã NLS: 2.4.TC1a] Phân tích video tình huống chiến thuật nhóm qua phần mềm phân tích thể thao số.\n• [Mã AI: 7.C5.1] AI mô phỏng các khoảng trống di chuyển chiến thuật hiệu quả trên sân đấu.'
      },
      {
        w: 30,
        t: 'Phần ba: Thể thao tự chọn',
      ...
      },
      {
        ...
        nls: '1.3.TC1a',
        ai: '7.D1.1',
        dc: '• [Mã NLS: 1.3.TC1a] Hoàn tất đồng bộ học bạ số môn Giáo dục thể chất 7 trên phần mềm quản lý trường học.\n• [Mã AI: 7.D1.1] AI tổng hợp báo cáo chỉ số phát triển thể chất toàn diện học sinh khối 7.'
      }
    ];
  ...
  if (g === 8) {
    const grade8Weeks = [
      ...
      },
      {
        ...
        nls: '5.2.TC2a',
        ai: '8.C2.1',
        dc: '• [Mã NLS: 5.2.TC2a] Quay video góc nghiêng bằng camera độ phân giải cao phân tích độ ngả thân người.\n• [Mã AI: 8.C2.1] AI Motion Analysis nhận diện góc độ tiếp đất của bàn chân và góc đánh tay.'
      },
      {
        w: 3,
        t: 'Chủ đề 1. Chạy cự li ngắn (100 m)',
      ...
      },
      {
        ...
        nls: '3.1.TC2a',
        ai: '8.D1.1',
        dc: '• [Mã NLS: 3.1.TC2a] Ghi lại video đồng diễn nhóm và biên tập clip ngắn có chèn hiệu ứng âm nhạc.\n• [Mã AI: 8.D1.1] AI phân tích nhịp phách âm nhạc (BPM) và gợi ý bài nhạc phù hợp với tốc độ vận động.'
      },
      {
        w: 5,
        t: 'Chủ đề 4. Bài tập thể dục',
      ...
      },
      {
        ...
        nls: '1.3.TC2a',
        ai: '8.A1.1',
        dc: '• [Mã NLS: 1.3.TC2a] Quản lý nhật ký rèn luyện thể lực cá nhân trên ứng dụng điện tử trường học.\n• [Mã AI: 8.A1.1] AI tổng hợp và đưa ra lời khuyên phân bổ thời gian tập luyện và nghỉ ngơi hợp lí.'
      },
      {
        w: 8,
        t: 'Ôn tập chuẩn bị kiểm tra giữa HK1',
      ...
      },
      {
        ...
        nls: '4.1.TC2a',
        ai: '8.C1.1',
        dc: '• [Mã NLS: 4.1.TC2a] Xem infographic quy chuẩn an toàn khi tập nhảy cao (sử dụng đệm dày, xà mềm chống va đập).\n• [Mã AI: 8.C1.1] Mô phỏng 3D góc đá lăng và lực giậm nhảy tạo động năng nâng trọng tâm cơ thể qua xà.'
      },
      {
        w: 11,
        t: 'Chủ đề 2. Nhảy cao kiểu bước qua',
        ...
        nls: '5.2.TC2a',
        ai: '8.C2.1',
        dc: '• [Mã NLS: 5.2.TC2a] Sử dụng ứng dụng quay chậm (Slow-motion) phân tích khoảnh khắc đặt chân giậm nhảy gót $\\rightarrow$ mũi.\n• [Mã AI: 8.C2.1] AI Motion Tracking đo đạc góc giậm nhảy và tốc độ chạy đà trước xà.'
      },
      {
        w: 12,
        t: 'Chủ đề 2. Nhảy cao kiểu bước qua',
      ...
      },
      {
        ...
        nls: '2.4.TC2a',
        ai: '8.D1.1',
        dc: '• [Mã NLS: 2.4.TC2a] Làm việc nhóm phân công điều chỉnh mức xà, đo đạc và quay video phân tích kỹ thuật.\n• [Mã AI: 8.D1.1] AI phân tích nguyên nhân phạm quy (chạm xà bằng gót/mông) và đưa ra bài tập sửa lỗi.'
      },
      {
        w: 14,
        t: 'Chủ đề 3. Chạy cự li trung bình',
      ...
      },
      {
        ...
        nls: '5.2.TC2a',
        ai: '8.D1.1',
        dc: '• [Mã NLS: 5.2.TC2a] Lưu trữ và vẽ biểu đồ tốc độ (Pacing chart) qua từng vòng chạy trên phần mềm bảng tính.\n• [Mã AI: 8.D1.1] AI gợi ý chiến thuật Pacing tối ưu hóa thành tích chạy bền lớp 8.'
      },
      {
        w: 16,
        t: 'Đánh giá định kỳ',
      ...
      },
      {
        ...
        nls: '5.2.TC2a',
        ai: '8.C2.1',
        dc: '• [Mã NLS: 5.2.TC2a] Quay video góc chậm (240fps) phân tích chuyển động chân giậm qua xà.\n• [Mã AI: 8.C2.1] AI nhận diện và cảnh báo nguy cơ va chạm xà dựa trên góc tiếp cận.'
      },
      {
        w: 21,
        t: 'Chủ đề 4. Bài tập thể dục',
      ...
      },
      {
        ...
        nls: '2.1.TC2a',
        ai: '8.C2.1',
        dc: '• [Mã NLS: 2.1.TC2a] Xem mô phỏng 3D vùng tiếp xúc trán giữa với bóng khi bật nhảy đánh đầu.\n• [Mã AI: 8.C2.1] AI phân tích lực bật nhảy và điểm rơi của quả bóng bổng.'
      },
      {
        w: 23,
        t: 'Phần ba: Thể thao tự chọn',
        ...
        nls: '5.2.TC2a',
        ai: '8.D2.1',
        dc: '• [Mã NLS: 5.2.TC2a] Sử dụng thiết bị đo tốc độ đập cầu (Speed radar) trong luyện tập cầu lông.\n• [Mã AI: 8.D2.1] AI phân tích góc cắm của quả đập cầu để đề xuất điểm rơi hiểm hóc.'
      },
      {
        w: 24,
        t: 'Phần ba: Thể thao tự chọn',
      ...
      },
      {
        ...
        nls: '3.1.TC2a',
        ai: '8.D2.1',
        dc: '• [Mã NLS: 3.1.TC2a] Vận hành hệ thống tính điểm và hiển thị thời gian thi đấu trên màn hình LED số.\n• [Mã AI: 8.D2.1] AI thống kê chỉ số hiệu quả thi đấu cá nhân (Player Efficiency Rating - PER).'
      },
      {
        w: 26,
        t: 'Đánh giá định kỳ',
        ...
        nls: '1.2.TC2a',
        ai: '8.A3.3',
        dc: '• [Mã NLS: 1.2.TC2a] Tra cứu thang điểm đánh giá kỹ thuật và thành tích thể thao lớp 8 trên cổng thông tin số.\n• [Mã AI: 8.A3.3] Thực hiện lưu trữ hồ sơ minh chứng kiểm tra minh bạch trên nền tảng đám mây.'
      },
      {
        w: 27,
        t: 'Chủ đề 3. Chạy cự li trung bình',
      ...
      },
      {
        ...
        nls: '2.4.TC2a',
        ai: '8.C2.1',
        dc: '• [Mã NLS: 2.4.TC2a] Phân tích video băng ghi hình trận đấu bằng phần mềm chiến thuật thể thao số.\n• [Mã AI: 8.C2.1] AI vẽ bản đồ nhiệt (Heatmap) thể hiện tầm hoạt động của từng vị trí trên sân.'
      },
      {
        w: 30,
        t: 'Phần ba: Thể thao tự chọn',
        ...
        nls: '3.1.TC2a',
        ai: '8.A1.1',
        dc: '• [Mã NLS: 3.1.TC2a] Sử dụng ứng dụng quản lý giải đấu tự động cập nhật bảng xếp hạng và lịch thi đấu.\n• [Mã AI: 8.A1.1] Công cụ AI hỗ trợ phát hiện lỗi chạm lưới/chạm tay/việt vị từ góc quay camera.'
      },
      {
        w: 31,
        t: 'Đánh giá định kỳ',
      ...
      },
      {
        ...
        nls: '1.3.TC2a',
        ai: '8.D1.1',
        dc: '• [Mã NLS: 1.3.TC2a] Hoàn tất đồng bộ học bạ số môn Giáo dục thể chất 8 trên phần mềm quản lý trường học.\n• [Mã AI: 8.D1.1] AI tổng hợp báo cáo chỉ số phát triển thể chất toàn diện học sinh khối 8.'
      }
    ];
  ...
  const grade9Weeks = [
    ...
    },
    {
      ...
      nls: '3.1.TC2a',
      ai: '9.D1.1',
      dc: '• [Mã NLS: 3.1.TC2a] Ghi hình bài tập thể dục nhịp điệu Phần 1 và biên tập video số chất lượng cao.\n• [Mã AI: 9.D1.1] Sử dụng AI hỗ trợ phối ghép âm nhạc điện tử khớp với nhịp phách của bài thể dục.'
    },
    {
      w: 5,
      t: 'Chủ đề 4. Bài tập thể dục',
    ...
    },
    {
      ...
      nls: '4.1.TC2a',
      ai: '9.C2.1',
      dc: '• [Mã NLS: 4.1.TC2a] Xem infographic quy chuẩn an toàn khi tập nhảy cao kiểu nằm nghiêng trên đệm mút.\n• [Mã AI: 9.C2.1] Mô phỏng 3D góc xoay hông và thân người nằm nghiêng song song với xà.'
    },
    {
      w: 11,
      t: 'Chủ đề 2. Nhảy cao kiểu nằm nghiêng',
    ...
    },
    {
      ...
      nls: '5.2.TC2a',
      ai: '9.C4.1',
      dc: '• [Mã NLS: 5.2.TC2a] Quay video góc chậm (240fps) phân tích chuyển động xoay thân và rút chân giậm qua xà.\n• [Mã AI: 9.C4.1] AI nhận diện và cảnh báo nguy cơ va chạm xà dựa trên góc tiếp cận.'
    },
    {
      w: 21,
      t: 'Chủ đề 4. Bài tập thể dục',
    ...
    },
    {
      ...
      nls: '2.1.TC2a',
      ai: '9.C2.1',
      dc: '• [Mã NLS: 2.1.TC2a] Xem mô phỏng 3D vùng tiếp xúc mu giữa bàn chân với bóng khi sút xa uy lực.\n• [Mã AI: 9.C2.1] AI phân tích lực bật nhảy và góc độ ném biên hợp lệ theo luật bóng đá.'
    },
    {
      w: 23,
      t: 'Phần ba: Thể thao tự chọn',
    ...
    },
    {
      ...
      nls: '1.3.TC2a',
      ai: '9.D1.1',
      dc: '• [Mã NLS: 1.3.TC2a] Hoàn tất đồng bộ học bạ số môn Giáo dục thể chất 9 trên phần mềm quản lý trường học.\n• [Mã AI: 9.D1.1] AI tổng hợp báo cáo chỉ số phát triển thể chất toàn diện học sinh tốt nghiệp THCS.'
    }
  ];
